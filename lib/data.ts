  ...
  work: [
    {
      ...
      description:
        "• Built a multi-tenant AI-powered commerce platform enabling organizations to manage businesses, products, orders, and customer interactions from a single system.\n• Integrated a RAG-powered chatbot across Facebook Messenger, Instagram, and WhatsApp using tool calling and vector search for product discovery, customer support, and order placement.\n• Built and managed a team of 2 engineers, conducted code reviews, and coordinated feature delivery.\n• Led customer development, finalized product requirements, ran demos, and generated 10+ early leads to validate product-market fit.",
      technologies: [
        "TypeScript",
        "Next.js",
        "React",
